...

{
  ...
  "description": "Tag to implement TikTok pixel. Perfectly compatible with multiple pixel IDs.",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    ...
    "help": "You can insert multiple pixel IDs separated by a comma.",
...
const trackEvent = function(thisPixelId){
...
const sendEvent = () => {
  ...
  tag_pixels.forEach(function(thisPixelId) {
    if (!pixels || !pixels[thisPixelId] || !pixels[thisPixelId]._init){
      log('TikTok| loading pixel '+thisPixelId);
      callInWindow('ttq.load',thisPixelId);
    }
    log('TikTok| '+thisPixelId+' is loaded.');
    trackEvent(thisPixelId);
  });
};

let sent = false;
let url = "https://analytics.tiktok.com/i18n/pixel/sdk.js"; // tiktok library
let supp_url = 'https://cdn.jsdelivr.net/gh/lorquez/Tiktok-gtm-template@v1.0/TikTokInstance.js'; // custom support library
if (isConsentGranted('ad_storage')){
  injectScript(supp_url,injectScript(url,sendEvent,data.gtmOnFailure),data.gtmOnFailure);
  sent = true;
} else {
      ...
      "param": [
        {
          ...
          "value": {
            ...
            "listItem": [
              {
                "type": 1,
                "string": "https://analytics.tiktok.com/i18n/pixel/sdk.js"
              },
              {
                "type": 1,
              ...
              {
                "type": 1,
                "string": "https://cdn.jsdelivr.net/gh/lorquez/Tiktok-gtm-template@v1.0/TikTokInstance.js"
              }
            ]
          }
        }
