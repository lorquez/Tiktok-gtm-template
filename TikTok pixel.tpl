...

{
  ...
  "description": "Tag to implement TikTok pixel (needs an additional custom html tag to be used with multiple pixels, see https://github.com/lorquez/Tiktok-gtm-template)",
  "containerContexts": [
    "WEB"
  ]
}
